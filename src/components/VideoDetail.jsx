      ...
      <Stack direction={{sx:'column',md:'row'}}>
        <Box flex={1}>        
            <Box sx={{width:'100%',position:'sticky',top:'86px'}}>
              ...
              <Stack direction="row" justifyContent="space-between" sx={{color:'purple'}} py={1} px={2}>
          ...
          <Box px={2} py={{md:1,xs:5}} justifyContent="center" alignItems="center"> <Videos videos={videos} direction="column"/> </Box>
       </Stack> 
     </Box>
  );
};
